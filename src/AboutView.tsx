        ...
        <div className="space-y-8">
          <section className="p-6 rounded border border-neon-pink/20 bg-neon-pink/5 backdrop-blur-sm">
            ...
            <p className="text-gray-300 leading-relaxed">
              We're dedicated to creating interactive and engaging experiences that challenge
              and educate our users. Our platform combines cutting-edge technology with
              thoughtful design to deliver memorable moments.
            </p>
          </section>
          ...
          <section className="p-6 rounded border border-neon-green/20 bg-neon-green/5 backdrop-blur-sm">
            ...
            <p className="text-gray-300 leading-relaxed">
              From interactive quizzes to personalized assessments, we build tools that are
              both fun and functional. Every feature is designed with the user experience in
